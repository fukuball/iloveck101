...
if (class_exists('Fukuball_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class Fukuball_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Fukuball_Sniffs_Commenting_ClassCommentSniff extends Fukuball_Sniffs_Commenting_FileCommentSniff
{
